...
<body>
	<div id="header">
		<h1 style="margin-left: 0px;padding-left: 0px;"><a href="#">黄科大</a></h1>	
		<!-- <h2 style="padding: 0px; margin-top: 10px; margin-bottom: 0px;">
			<a href="#"><font color="#cccccc">黄科大论坛</font></a>
		</h2>
	...
	<div id="content">
		...
		<div class="row-fluid">
			<div id="footer" class="span12">
				2017 &copy; 黄科大. 作者：小康&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://localhost:8080/Forum/">师生交流社区</a>
			</div>
		</div>
	</div>
